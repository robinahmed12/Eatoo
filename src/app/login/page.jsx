  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-[#EDF6F9] p-4 sm:p-6 lg:p-8">
      <div
        ...
        data-aos="fade-up"
      >
        <h2 className="text-3xl font-bold text-center text-[#1D3557] mb-8" data-aos="fade-up" data-aos-delay="100">
          Welcome to MealDash
        </h2>
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div data-aos="fade-up" data-aos-delay="300">
            <label htmlFor="password" className="block text-sm font-medium text-[#1D3557] mb-2">
              Password
            </label>
            <input
              type="password"
        ...
        <p className="mt-8 text-center text-[#1D3557]" data-aos="fade-up" data-aos-delay="500">
          ...
          <Link href="/register" className="text-[#E63946] hover:underline font-medium">
            Register here
          </Link>
        </p>
      </div>
